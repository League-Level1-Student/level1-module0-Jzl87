...
public class FinishLine {
	...
	public static void main(String[] args) {
		...
		//5. If the robot has crossed the finish line... 
			if (hasCrossedLine) {
				JOptionPane.showMessageDialog(null, "Your robot finished! He went a whooping " +totalDistance + " meters. Good for him");
			} else {
				JOptionPane.showMessageDialog(null, "Your robot went " +totalDistance + " meters. He did not finish :(");
			}
